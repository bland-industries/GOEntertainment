...
import planB.AddDVD.ImageListener;
...
public class AddTV extends JDialog{
	...
	public AddTV (JFrame frame, ActionListener list) {
	...
	public class DialogPanel extends JPanel {
		...
		public DialogPanel () {
			...
			seasonf = new JTextField(20);

			add(season);
			add(seasonf);

			year = new JLabel("year");
			yearf = new JTextField(20);
			...
			Actors1 = new JTextField(20);

			Actors2 = new JTextField(20);

			Actors3 = new JTextField(20);

			Actors4 = new JTextField(20);

			Actors5 = new JTextField(20);
